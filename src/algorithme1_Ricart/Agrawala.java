...
public class Agrawala extends Thread {
	int[] ports = {8111,8222,8333,8444};
	boolean waiting=false,accessing=false;
	private int hi,lastDate = 0;
	LinkedList<Processus> 
			Ri = new LinkedList<Processus>(), 
			waitingList = new LinkedList<Processus>(),
	...
	public static void main(String[] args) {
		...
		Agrawala p = new Agrawala(port);
		p.start();
		p.createServer();

	}
	public Agrawala(int port){
		this.port=port;
		this.ID=port;
	}
	public void run() {
